...
The **Study Streak Tracker** is a frontend-only web application built using **React** and **JavaScript**. It allows users to track their daily study activities across multiple subjects.
...
### ✅ Day 1
- Initialize React app using Vite or CRA  
- Set up folder structure and boilerplate  
- Create basic layout and plan core components (SubjectCard, Header, etc.)
...
- Implement adding and deleting subjects  
